...
import io.ducket.api.test_data.TransactionObjectMother
...
internal class AccountServiceTest {
    ...
    fun should_ReturnAccessibleUserAccount_When_GetUserAccount() {
        ...
        // when
        val actual = accountServiceSpy.getAccountAccessibleToUser(user.id, accounts[0].id)
    ...
    fun should_ThrowException_When_GetNonexistentUserAccount() {
        ...
        // when
        val executable: () -> Unit = { accountServiceSpy.getAccountAccessibleToUser(user.id, 10L) }
